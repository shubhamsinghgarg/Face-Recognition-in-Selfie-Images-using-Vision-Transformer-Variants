...
train_transform = transforms.Compose([
    transforms.Resize((256, 256)),  # Adjust size to match model expected input
...
model_name = 'mobilevit_s'  # Adjust model name as needed
...
# Save the model
torch.save(v.state_dict(), 'mobilevit_model_wsd.pth')

# To load the model for future use
# v.load_state_dict(torch.load('mobilevit_model_wsd.pth'))
