...
train_transform = transforms.Compose([
    transforms.Resize((240, 240)),  # Adjust size to match model expected input
...
# Initialize the pretrained model (CrossViT)
model_name = 'crossvit_9_240'  # Adjust model name as needed
...
# Save the model
torch.save(v.state_dict(), 'crossvit_model_wsd.pth')

# To load the model for future use
# v.load_state_dict(torch.load('crossvit_model_wsd.pth'))
